...
// Cli - command line interface for shell generator
func Cli() {
	// menu - user interface //
	fmt.Println("|==================================|")
	...
	for {
		...
		fmt.Printf("|   2   | Height of shell          : %3.3v meter\n", height)
		fmt.Printf("|   3   | Diameter of shell        : %3.3v meter\n", diameter)
		fmt.Printf("|   4   | Precision                : %3.3v meter\n", precision)
		fmt.Printf("|   5   | Amount vert. stiffiners  : %3v items\n", amountVertStiff)
		fmt.Printf("|   6   | Amount horiz. stiffiners : %3v items\n", amountHorizStiff)
		fmt.Printf("|   7   | Height of stiffiners     : %3.3v meter\n", stifHeight)
		fmt.Println("|       |                          |")
